...
Thank you for your interest in contributing to NexusGuard! We welcome contributions from developers, designers, security auditors, and community members. 

By participating in this project, you help build a more transparent, accessible, and self-governed peer-to-peer microinsurance protocol on the Stellar network.
...
Have an idea for a new feature, a payout cap algorithm, or an improved UI component? Open an issue describing:
*   The goal of the enhancement.
*   How it should behave.
*   Why it adds value to the protocol.
...
### Prerequisites
To build and run NexusGuard, you need:
...
*   `feature/` (e.g., `feature/x402-payout-validation`)
*   `bugfix/` (e.g., `bugfix/join-button-visibility`)
...
Examples:
*   `feat(contracts): add 60-day signer rotation logic`
*   `fix(frontend): resolve wallet disconnect edge-case`
*   `docs(readme): add troubleshooting section for docker`
*   `style(frontend): adjust button padding in explore pools`
